...
public class JwtPostProccessingToken extends UsernamePasswordAuthenticationToken {
    private JwtPostProccessingToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) {
        super(principal, credentials, authorities);
    }

    public JwtPostProccessingToken(String nickname, UserRole role){
        super(nickname, "1234", parseAuthorities(role));
    }
